...
final class RecaptchaV2EnterpriseTaskProxyless extends AbstractRecaptchaV2EnterpriseTask
{
    /*
     *
    ...
    public function __construct(
        ...
        parent::__construct($websiteUrl, $websiteKey, $enterprisePayload, $apiDomain, type: TypeTask::RECAPTCHA_V2_ENTERPRISE_TASK_PROXYLESS);
    }
}